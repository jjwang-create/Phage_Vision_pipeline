...
Input: morphology_pipeline/data/A_html2article/*.json
Output: morphology_pipeline/data/B_sorted_paper/*.json (phage-related only; may symlink parent)
"""
...
# Configuration
INPUT_DIR = "/home/ubuntu/jiajunwang/extraction_trial/morphology_pipeline/data/A_html2article"
OUTPUT_DIR = "/home/ubuntu/jiajunwang/extraction_trial/morphology_pipeline/data/B_sorted_paper"
